        ...
        <div className={`bg-white border-2 rounded shadow-[6px_6px_0px_0px_rgba(0,0,0,0.9)] transition-colors ${shake ? 'animate-shake border-red-500' : 'border-gray-900'}`}>
          ...
          <div className="px-8 pb-5 pt-1">
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 w-full border-2 border-[#5865F2] hover:bg-[#5865F2] text-[#5865F2] hover:text-white font-black py-2.5 rounded text-sm uppercase tracking-wide transition-colors no-underline group mb-3"
            >
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 w-full border-2 border-gray-300 hover:border-gray-900 hover:bg-gray-900 text-gray-700 hover:text-white font-black py-2.5 rounded text-sm uppercase tracking-wide transition-colors no-underline"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
